...
def main():
    ...
    print("""
  #################################################
  # KAT 10thMods Development Environment Setup #
  #################################################

  This script will create your KAT 10thMods dev environment for you.
  ...
  This script will create two hard links on your system, both pointing to your KAT 10thMods project folder:
    [Arma 3 installation directory]\\{} => KAT 10thMods project folder
    P:\\{}                              => KAT 10thMods project folder
