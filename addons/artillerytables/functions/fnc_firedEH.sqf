 ...
 *
 * Example:
 * [bisFiredEH] call kat_10thmods_artillerytables_fnc_firedEH
 *
 * Public: No
 */
...
if (!([_gunner] call ace_common_fnc_isPlayer)) exitWith {}; // AI don't know how to use (this does give them more range than a player)
