...
private _ret = "kat_artillerytables" callExtension ["start", [_muzzleVelocity,_airFriction,_elevMin,_elevMax,GVAR(lastElevationMode)]];
TRACE_1("",_ret);
...
[{
    ...
    while {_status == 1} do {
        private _ret = ("kat_artillerytables" callExtension ["getline", []]);
