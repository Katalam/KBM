...
[_object, 0, [],
	[QGVAR(specActionParent), "Spectator", "", {}, {true}] call ace_interact_menu_fnc_createAction
] call ace_interact_menu_fnc_addActionToObject;

[_object, 0, [QGVAR(specActionParent)],
	[QGVAR(specAction0), "Spectator werden", "", _specCode, {true}, {}, _markerName] call ace_interact_menu_fnc_createAction
] call ace_interact_menu_fnc_addActionToObject;
